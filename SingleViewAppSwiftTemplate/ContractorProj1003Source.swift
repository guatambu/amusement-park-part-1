...
class ContractorProj1003Source: PersonSource {
        ...
        )
    {
        ...
        self.init(
            entrantType: [.contractorProj1003],
            areaAccess: [.amusement, .rideControl, .maintenance, .kitchen, .office],
            ridePrivileges: [.none],
            discountAccess: [.none],
            discountAmount: [.none],
